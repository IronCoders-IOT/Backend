...
import com.ironcoders.aquaconectabackend.monitoring.domain.model.queries.GetAllWaterSupplyRequestsQuery;
import com.ironcoders.aquaconectabackend.monitoring.domain.model.queries.GetWaterSupplyRequestByIdQuery;
...
import com.ironcoders.aquaconectabackend.monitoring.interfaces.rest.transform.CreateWaterSupplyRequestCommandFromResourceAssembler;
import com.ironcoders.aquaconectabackend.monitoring.interfaces.rest.transform.UpdateWaterSupplyRequestCommandFromResource;
...
public class WaterSupplyRequestController {
    ...
    public ResponseEntity<WaterSupplyRequestResource> updateWaterRequest(
        ...
        return result
                .map(obj -> WaterRequestResourceFromAggregateAssembler.toResourceFromEntity((com.ironcoders.aquaconectabackend.monitoring.domain.model.aggregates.WaterSupplyRequest) obj))
