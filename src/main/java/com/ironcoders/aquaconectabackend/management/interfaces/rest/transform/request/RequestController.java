...
import com.ironcoders.aquaconectabackend.management.interfaces.rest.transform.RequestResourceFromEntityAssembler;
...
public class RequestController {
    ...
    {
        CreateRequestCommand createRequestCommand = RequestCommandFromResourceAssembler.toCommandFromResource(resource);
        ...
        var requestResource = RequestResourceFromEntityAssembler.toResourceFromAggregate(request.get());
