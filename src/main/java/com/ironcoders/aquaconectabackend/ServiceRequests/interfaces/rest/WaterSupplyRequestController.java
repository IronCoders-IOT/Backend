package com.ironcoders.aquaconectabackend.ServiceRequests.interfaces.rest;
...
import com.ironcoders.aquaconectabackend.ServiceRequests.domain.model.queries.GetAllWaterSupplyRequestsQuery;
import com.ironcoders.aquaconectabackend.ServiceRequests.domain.model.queries.GetWaterSupplyRequestByIdQuery;
import com.ironcoders.aquaconectabackend.ServiceRequests.domain.services.WaterSupplyRequestCommandService;
...
import com.ironcoders.aquaconectabackend.ServiceRequests.interfaces.rest.transform.CreateWaterSupplyRequestCommandFromResourceAssembler;
import com.ironcoders.aquaconectabackend.ServiceRequests.interfaces.rest.transform.UpdateWaterSupplyRequestCommandFromResource;
...
public class WaterSupplyRequestController {
    ...
    public ResponseEntity<WaterSupplyRequestResource> updateWaterRequest(
        ...
        return result
                .map(obj -> WaterRequestResourceFromAggregateAssembler.toResourceFromEntity((com.ironcoders.aquaconectabackend.ServiceRequests.domain.model.aggregates.WaterSupplyRequest) obj))
